...
def test_client_tables_are_isolated() -> None:
    ...
    assert goliath.companies_table == "goliath_wf_companies"
    assert goliath.contacts_table == "goliath_wf_contacts"
    assert basco.companies_table != peterson.companies_table
    assert "Owner" in goliath.titles
